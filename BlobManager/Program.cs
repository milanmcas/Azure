...
public class Program
{
    ...
    //private const string blobServiceEndpoint = "https://mediastor51633387.blob.core.windows.net/";
    private const string blobServiceEndpoint = "https://mediastor151633387.blob.core.windows.net/";
    //Update the storageAccountName value that you recorded previously in this lab.
    //private const string storageAccountName = "mediastor51633387";
     private const string storageAccountName = "mediastor151633387";
    //Update the storageAccountKey value that you recorded previously in this lab.
    //private const string storageAccountKey = "QxZMP3Mc637UIDFB2mQXjr1gaBVxjLWCbmDZBlViLWgp2593QXsHBr5UJPG8odAkL5k/Ipjly+eY+AStyWJTfg==";
    private const string storageAccountKey = "Nj84JEvbHcE0OvkxDcjeHzCMiMwV0abWLrOQaSvj9H9HCB86WfxQLkaG4wKUlPR2+bRRtoGAXyOq+AStDj8l3w==";
